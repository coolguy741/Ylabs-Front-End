    ...
    <>
      {
        ...
        :
        <div className='w-[110px] h-[110px] flex justify-center'> 
          <img className="w-3/4 h-3/4 z-20 m-auto rotate-counterclockwise" src="./icons/ComingSoonIconWordDark.svg" alt="Comming Soon Word"/>
